      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-secondary-gray">
              <li><Link href="#" className="hover:text-primary-green transition-colors">About Us</Link></li>
              <li><Link href="#" className="hover:text-primary-green transition-colors">Careers</Link></li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-secondary-gray">
              <li><Link href="#" className="hover:text-primary-green transition-colors">Privacy Policy</Link></li>
              <li><Link href="#" className="hover:text-primary-green transition-colors">Terms of Service</Link></li>
              <li><Link href="#" className="hover:text-primary-green transition-colors">Cookie Policy</Link></li>
              <li><Link href="#" className="hover:text-primary-green transition-colors">Security</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border-stroke pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8 text-sm text-secondary-gray">
            <Link href="#" className="hover:text-primary-green">Status</Link>
            <Link href="#" className="hover:text-primary-green">Support</Link>
            <Link href="#" className="hover:text-primary-green">Feedback</Link>
          </div>
        </div>
      </div>
    </footer>
