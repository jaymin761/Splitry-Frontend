      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-[#111522]/90 rounded-3xl border border-white/10 shadow-xl p-6 sm:p-12 space-y-12">
          ...
          <div className="p-6 bg-emerald-500/5 border border-emerald-500/20 rounded-2xl flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-white text-lg mb-1">Important User Agreement Notice</h3>
          ...
          <section className="p-6 sm:p-8 bg-[#0B0E14] border border-emerald-500/30 rounded-3xl space-y-4">
          ...
          <section>
            ...
            <ul className="space-y-3 text-slate-300 text-sm sm:text-base">
              ...
              <li className="flex gap-3">
                <span className="text-emerald-400 font-bold">•</span>
                <span><strong>Unauthorized Access:</strong> Notify us immediately at <a href="mailto:splitry@gmail.com" className="text-emerald-400 underline font-semibold">splitry@gmail.com</a> if you suspect unauthorized activity on your account.</span>
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
              <span className="w-8 h-8 rounded-xl bg-white/10 text-emerald-400 flex items-center justify-center text-sm font-bold border border-white/10">4</span>
            ...
            <div className="grid gap-3 sm:grid-cols-2 text-xs sm:text-sm text-slate-300">
          ...
          <section className="p-6 bg-amber-500/10 border border-amber-500/25 rounded-3xl space-y-3 text-amber-200">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
              <span className="w-8 h-8 rounded-xl bg-white/10 text-emerald-400 flex items-center justify-center text-sm font-bold border border-white/10">9</span>
          ...
          <section className="p-6 bg-[#0B0E14] rounded-3xl border border-white/10 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-xl font-bold text-white mb-1">Questions About Our Terms?</h3>
